      ...
      {loading ? (
        ...
        <div className="space-y-4">
          ...
          {videos.map((v, idx) => {
            ...
            return (
              <div key={v.id}
                className={`bg-white rounded-2xl border overflow-hidden shadow-sm flex ${v.is_active ? "border-cream-100" : "border-cream-200 opacity-60"}`}>
                ...
                <div className="flex-1 p-4 flex items-center justify-between gap-3 min-w-0">
                  <div className="min-w-0">
                    ...
                    {v.description && (
                      <p className="text-xs text-charcoal-800/50 truncate mt-0.5">{v.description}</p>
                    )}
        ...
        <div className="fixed inset-0 z-50 bg-black/50 flex items-center justify-center p-4">
          <div className="bg-white w-full max-w-lg rounded-2xl shadow-2xl">
            ...
            <div className="p-6 space-y-4">
              ...
              <div>
                <label className="text-xs uppercase tracking-wider text-charcoal-800/50 mb-1 block">YouTube URL *</label>
